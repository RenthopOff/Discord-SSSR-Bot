...
exports.run = async (bot, message, args) => {
    ...
    const a = message.guild.roles.get('495605551774826519'); // Moderator
    const b = message.guild.roles.get('495199722458316825'); // Administrator
    const c = message.guild.roles.get('538320686150713356'); // Developer
